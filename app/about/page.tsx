...
export default function About() {
  ...
  return (
    <div className="h-body flex flex-col items-center justify-center p-6">
      <div
        className={`w-full max-w-5xl rounded-lg p-8 shadow-lg ${
          theme === 'dark'
      ...
      >
        ...
        <section className="mb-12">
          ...
          <p className="mb-6">
            I am continually exploring new technologies and frameworks to stay at the forefront of
            the industry. My goal is to leverage my skills to create applications that offer
            exceptional user experiences and meet the highest standards of performance and security.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="mb-6">
            ...
            and creatively inspired. These hobbies contribute to a balanced and fulfilling
            lifestyle.
          </p>
          <p>
